...
namespace MemoryProfilerWindow
{
    ...
    public class Table
    {
		...
		void DrawTitle(GUIContent content, int index, bool setup)
		{
			...
			bool didSelectColumn = (index == 0) ?
				GUILayout.Toggle(isSelected, content, styles.header) :
				GUILayout.Toggle(isSelected, content, styles.rightHeader, GUILayout.Width(width));
