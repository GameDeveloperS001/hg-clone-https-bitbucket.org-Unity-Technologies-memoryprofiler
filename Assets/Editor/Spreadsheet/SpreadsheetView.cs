...
namespace MemoryProfilerWindow
{
    public class SpreadsheetView
    {
		...
		GUIContent DataForGrid(int id, int col)
		{
			...
			var gcHandle = thing as GCHandle;
		...
		int CompareData(int id1, int id2, int col)
		{
			...
			var managedObject1 = thing1 as ManagedObject;
			var gcHandle1 = thing1 as GCHandle;
			var staticFields1 = thing1 as StaticFields;

			ThingInMemory thing2 = m_unpackedCrawl.allObjects[id2];
			var nativeObject2 = thing2 as NativeUnityEngineObject;
			var managedObject2 = thing2 as ManagedObject;
			var gcHandle2 = thing2 as GCHandle;
			var staticFields2 = thing2 as StaticFields;
